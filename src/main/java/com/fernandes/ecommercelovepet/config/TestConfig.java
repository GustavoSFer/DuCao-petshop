...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		Usuario usuario = new Usuario("James Brown", "35812584584", 1144678521, "james@gmail.com", "123", true);
		Usuario cliente = new Usuario("Aurelina Silva Nega", "1129884569", 1144615814, "aurelina@gmail.com", "365", false);
